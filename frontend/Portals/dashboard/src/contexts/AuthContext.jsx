...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    const finalEmail = String(form.elements.email?.value || email || '').trim().toLowerCase();
    const finalPassword = String(form.elements.password?.value || password || '');
    ...
    if (is2FARequired) {
      setTempCredentials({ email: finalEmail, password: finalPassword });
      setShow2FA(true);
      return;
    }
            ...
            {show2FA ? (
              <form onSubmit={handleVerify2FA} className="w-full max-w-[320px] flex flex-col items-center">
                <p className="text-xs text-gray-500 text-center mb-4 leading-relaxed">
                  ...
                  <br />
                  <span className="text-[10px] text-gray-400">Demo code: 123456</span>
                </p>
                ...
                <div className="w-full flex justify-between items-center mt-2">
                  <button
                    ...
                    className="text-xs text-gray-400 hover:text-gray-600 bg-transparent cursor-pointer flex items-center gap-1"
                  >
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="bg-[#6b1d44] text-white text-xs font-bold uppercase tracking-wider py-2.5 px-6 rounded-full shadow-md hover:opacity-90 disabled:opacity-50 cursor-pointer"
                  >
              ...
              <form onSubmit={handleLogin} className="w-full max-w-[320px] flex flex-col items-center">
                <input
                  ...
                  required
                  className="w-full border-b border-gray-300 py-2 text-sm text-gray-800 outline-none focus:border-[#6b1d44] mb-5 bg-transparent"
                />
                ...
                <input
                  ...
                  required
                  className="w-full border-b border-gray-300 py-2 text-sm text-gray-800 outline-none focus:border-[#6b1d44] mb-6 bg-transparent"
                />
                ...
                <div className="w-full flex justify-between items-center mt-2">
                  <button
                    ...
                    className="text-xs text-gray-400 hover:text-[#6b1d44] bg-transparent cursor-pointer"
                  >
                    Forgot Password?
                  </button>
              ...
              <form onSubmit={handleResetPassword} className="w-full max-w-[320px] flex flex-col items-center">
                ...
                <div className="w-full flex justify-between items-center mt-2">
                  <button
                    ...
                    className="text-xs text-gray-400 hover:text-gray-600 bg-transparent cursor-pointer"
                  >
                    Back to Sign In
                  </button>
                  ...
                  <button
                    type="submit"
                    className="bg-[#6b1d44] text-white text-xs font-bold uppercase tracking-wider py-2.5 px-6 rounded-full shadow-md hover:opacity-90 cursor-pointer"
                  >
                    Send Reset Link
                  </button>
                </div>
